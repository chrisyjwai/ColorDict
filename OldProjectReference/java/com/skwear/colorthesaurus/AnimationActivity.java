...
public class AnimationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AVDWrapper.Callback callback = new AVDWrapper.Callback() {
            ...
            public void onAnimationDone() {
                goToSecondActivity(colorTouched);
            }
    ...
    public void animate(int pixel) {
        ...
        if (s.equals(angercolor)) {
            imageView.setImageDrawable(getDrawable(R.drawable.avd_anger));
            //((Animatable) imageView.getDrawable()).start();

        } else if (s.equals(happinesscolor)) {
            imageView.setImageDrawable(getDrawable(R.drawable.avd_happiness));
            //((Animatable) imageView.getDrawable()).start();

        } else if (s.equals(sadnesscolor)) {
            imageView.setImageDrawable(getDrawable(R.drawable.avd_sadness));
            //((Animatable) imageView.getDrawable()).start();

        } else if (s.equals(disgustcolor)) {
            imageView.setImageDrawable(getDrawable(R.drawable.avd_disgust));
            //((Animatable) imageView.getDrawable()).start();

        } else if (s.equals(surprisecolor)) {
            imageView.setImageDrawable(getDrawable(R.drawable.avd_surprise));
            //((Animatable) imageView.getDrawable()).start();

        } else if (s.equals(fearcolor)) {
            imageView.setImageDrawable(getDrawable(R.drawable.avd_fear));
            //((Animatable) imageView.getDrawable()).start();

        }
    }

    public void goToSecondActivity(int pixel) {
